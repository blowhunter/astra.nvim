...
impl TranslationStore {
    ...
    fn load_default_translations(&mut self) {
        ...
        self.add_translation(
            "cli.sync_failed",
            Language::Spanish,
            "Sincronización fallida con {0} errores",
        );
        self.add_translation(
            "cli.sync_failed",
            Language::French,
            "Échec de la synchronisation avec {0} erreurs",
        );
        self.add_translation(
            "cli.sync_failed",
            Language::German,
            "Synchronisierung fehlgeschlagen mit {0} Fehlern",
        );
        self.add_translation(
            "cli.sync_failed",
            Language::Russian,
            "Синхронизация не удалась с {0} ошибками",
        );
        ...
        self.add_translation(
            "cli.pending_operations",
            Language::French,
            "Opérations en attente: {0}",
        );
        self.add_translation(
            "cli.pending_operations",
            Language::German,
            "Ausstehende Operationen: {0}",
        );
        self.add_translation(
            "cli.pending_operations",
            Language::Russian,
            "Ожидающие операции: {0}",
        );
